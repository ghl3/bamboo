...
def test_pivot_groups_2():
    ...
    assert_series_equal(pivoted['X'], pd.Series([2, None, None], index=['A', 'B', 'C']))
    assert_series_equal(pivoted['Y'], pd.Series([None, 4, None], index=['A', 'B', 'C']))
    assert_series_equal(pivoted['Z'], pd.Series([None, None, 6], index=['A', 'B', 'C']))
